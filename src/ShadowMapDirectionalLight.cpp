//===============================================================================================//
/*!
 *  \file      ShadowMapDirectionalLight.cpp
...
ShadowMapDirectionalLight::~ShadowMapDirectionalLight(void)
{

}

void ShadowMapDirectionalLight::init(const std::string & pPathVS, const std::string & pPathFS)
{
...
void ShadowMapDirectionalLight::WVP(const mat4f & pWVP)
{
    glUniformMatrix4fv(mWVPLocation, 1, GL_TRUE, const_cast<mat4f &>(pWVP).data());
}

bool ShadowMapDirectionalLight::checkUniformLocations(void) const
{
